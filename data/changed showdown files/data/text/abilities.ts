export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	disguise: {
		name: "Disguise",
		desc: "The first hit this Pokemon takes in battle deals 0 neutral damage. Its disguise is then broken, it changes to Busted Form, and it loses 1/8 of its max HP. Confusion damage also breaks the disguise.",
	...
	flowergift: {
		name: "Flower Gift",
		desc: "If this Pokemon is a Cherrim and Sunny Day is active, it changes to Sunshine Form and the Attack, Special Attack, and Special Defense of it and its allies are multiplied by 1.5. Summons Sunny Day. If this Pokemon is a Cherrim and it is holding Utility Umbrella, it remains in its regular form and the Attack and Special Defense stats of it and its allies are not boosted. If this Pokemon is a Cherrim in its Sunshine form and is given Utility Umbrella, it will immediately switch back to its regular form. If this Pokemon is a Cherrim holding Utility Umbrella and its item is removed while Sunny Day is active, it will transform into its Sunshine Form. If an ally is holding Utility Umbrella while Cherrim is in its Sunshine Form, they will not receive the Attack and Special Defense boosts.",
		shortDesc: "If user is Cherrim and Sunny Day is active, it and allies' Attack, Sp. Atk, and Sp. Def are 1.5x. Summons Sunny Day.",
		gen7: {
	...
	fullmetalbody: {
		...
		desc: "Prevents other Pokemon from lowering this Pokemon's stat stages. Moongeist Beam, Sunsteel Strike, and the Mold Breaker, Teravolt, and Turboblaze Abilities cannot ignore this Ability. Immune to status and non-attacking damage. Multiplies power of Steel moves by 1.3.",
		shortDesc: "Other Pokemon can't lower this Pokemon's stat stages. 1.3x boost to Steel moves. Immune to status and indirect damage.",
	},
	furcoat: {
		name: "Fur Coat",
	...
	minus: {
		name: "Minus",
		desc: "If an active ally has this Ability or the Plus Ability, this Pokemon's Special Attack is multiplied by 1.5. On switch-in, lowers opposing Pokemon's Sp.Atk 2 stages.",
		shortDesc: "On switch-in, lowers opposing Pokemon's Sp.Atk 2 stages.",
		gen4: {
	...
	neuroforce: {
		name: "Neuroforce",
		shortDesc: "This Pokemon's attacks that are super effective against the target do 1.25x damage. Photon Geyser power is multiplied by 1.6.",
	},
	neutralizinggas: {
	...
	plus: {
		name: "Plus",
		desc: "If an active ally has this Ability or the Minus Ability, this Pokemon's Special Attack is multiplied by 1.5. On switch-in, this Pokemon's Special Attack is raised 2 stages.",
		shortDesc: "Sp.Atk is raised 2 stages on switch-in.",
		gen4: {
	...
	powerconstruct: {
		...
		desc: "If this Pokemon is a Zygarde in its 10% or 50% Forme, it changes to Complete Forme when it has 1/2 or less of its maximum HP at the end of the turn. While this Pokemon is active, the Dark Aura and Fairy Aura power modifier is 0.75x.",
		shortDesc: "If Zygarde 10%/50%, changes to Complete if at 1/2 max HP or less at end of turn. While this Pokemon is active, the Dark Aura and Fairy Aura power modifier is 0.75x.",
	...
	slowstart: {
		name: "Slow Start",
		shortDesc: "This Pokemon's Attack and Speed are halved for 5 turns. Timer does not reset upon switching out.",
	...
	speedboost: {
		name: "Speed Boost",
		desc: "On switch-in, this Pokemon's Speed is raised 1 stage.",
		shortDesc: "On switch-in, this Pokemon's Speed is raised 1 stage.",
	},
	stakeout: {
		name: "Stakeout",
	...
	steamengine: {
		name: "Steam Engine",
		shortDesc: "This Pokemon's Speed is raised by 6 stages after it is targeted by Fire/Water moves, and is immune to Fire/Water moves.",
	},
	steelworker: {
		name: "Steelworker",
	...
	symbiosis: {
		name: "Symbiosis",
		desc: "If an ally uses its item, this Pokemon gives its item to that ally immediately. Does not activate if the ally's item was stolen or knocked off. Used items are returned at the end of the turn they are used.",
		shortDesc: "Used items are returned at the end of the turn they are used.",
	...
	teravolt: {
		name: "Teravolt",
		shortDesc: "This Pokemon's moves and their effects ignore the Abilities of other Pokemon. Multiplies the power of Electric moves by 1.3",
	...
	turboblaze: {
		name: "Turboblaze",
		shortDesc: "This Pokemon's moves and their effects ignore the Abilities of other Pokemon. Multiplies the power of Fire moves by 1.3.",
	...
	watercompaction: {
		...
		shortDesc: "This Pokemon's Defense is raised 2 stages after it is damaged by a Water-type move. Immune to Water-type moves.",
	},
	waterveil: {
		name: "Water Veil",
	...
	wonderguard: {
		name: "Wonder Guard",
		shortDesc: "This Pokemon can only be damaged by supereffective moves and indirect damage. On switch-in, this Pokemon shudders if any foe has a supereffective or OHKO move.",
		gen4: {
